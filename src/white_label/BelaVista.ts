...
const BelaVista: IProjectProps = {
  ios_store_url:
    'itms-apps://itunes.apple.com/us/app/apple-store/1580330257?mt=8',
  android_strore_url:
    'https://play.google.com/store/apps/details?id=com.arena_BelaVista_sp_brazil_2',
  ...
  backend_url: 'https://dev.pluma.tech',
  ...
  isUsingScore: false,
  willRunSchedules: false,
  sendAppointmentCreatedEmail: false,
};
